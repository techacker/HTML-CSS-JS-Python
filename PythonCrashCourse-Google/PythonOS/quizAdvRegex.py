...
# we'll ignore the possibility of a hash mark embedded inside of a Python command, and assume that it's 
# only used to indicate a comment. We also want to treat repetitive hash marks (##), (###), etc., 
